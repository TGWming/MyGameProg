...
public:
	...
	/**
	 * Get target socket world location with offset
	 * @param Target - The target actor
	 * @return World location of the socket or fallback location
	 */
	...
	/**
	 * Update socket projection widget position
	 */
	UFUNCTION(BlueprintCallable, Category = "Socket Projection")
	...
	/**
	 * Get socket projection settings
	 */
	UFUNCTION(BlueprintPure, Category = "UI Manager")
	const FSocketProjectionSettings& GetSocketProjectionSettings() const { return SocketProjectionSettings; }

	/**
	 * Set socket projection settings
	 * @param NewSettings - The new socket projection settings
	 */
	UFUNCTION(BlueprintCallable, Category = "UI Manager")
	void SetSocketProjectionSettings(const FSocketProjectionSettings& NewSettings);
	...
	/** Socket projection configuration */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "UI Configuration")
